-- Migration: Add Doctor and Certificate Management System
-- Creates doctors, universities, certificate_types, doctor_employment_history,
-- doctor_certificates, doctor_promotions, doctor_financial_grades, and doctor_documents tables.
